...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="svelte-1u9z1tp"><div class="corner svelte-1u9z1tp" data-svelte-h="svelte-1jb641n"><a href="https://kit.svelte.dev" class="svelte-1u9z1tp"><img${add_attribute("src", logo, 0)} alt="SvelteKit" class="svelte-1u9z1tp"></a></div> <nav class="svelte-1u9z1tp"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-1u9z1tp"></path></svg> <ul class="svelte-1u9z1tp"><li${add_attribute("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/" class="svelte-1u9z1tp" data-svelte-h="svelte-5a0zws">Home</a></li> <li${add_attribute("aria-current", $page.url.pathname === "/about-us" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/about-us" class="svelte-1u9z1tp" data-svelte-h="svelte-rzy1us">About us</a></li> <li${add_attribute("aria-current", $page.url.pathname === "/services" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/services" class="svelte-1u9z1tp" data-svelte-h="svelte-o59igb">Services</a></li> <li${add_attribute(
    "aria-current",
    $page.url.pathname === "/kooperationen" ? "page" : void 0,
    0
  )} class="svelte-1u9z1tp"><a href="/kooperationen" class="svelte-1u9z1tp" data-svelte-h="svelte-7z3tm7">Kooperationen</a></li> <li${add_attribute("aria-current", $page.url.pathname === "/kontakt" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/kontakt" class="svelte-1u9z1tp" data-svelte-h="svelte-q7g403">Kontakt</a></li></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-1u9z1tp"></path></svg></nav> <div class="corner svelte-1u9z1tp" data-svelte-h="svelte-1gilmbv"><a href="https://github.com/sveltejs/kit" class="svelte-1u9z1tp"><img${add_attribute("src", github, 0)} alt="GitHub" class="svelte-1u9z1tp"></a></div> </header>`;
});
const styles = "";
